...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = fan1In_Pin|fan2In_Pin;
  ...
  /* USER CODE END TIM2_MspInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = fan3In_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(fan3In_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = fan4In_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(fan4In_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    GPIO_InitStruct.Pin = fan5In_Pin|fan6In_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM5_MspInit 0 */
    ...
    PA1     ------> TIM5_CH2
    */
    GPIO_InitStruct.Pin = fan7In_Pin|fan8In_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = Fan1Out_Pin|Fan2Out_Pin;
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PB11     ------> TIM2_CH4
    */
    GPIO_InitStruct.Pin = fan3Out_Pin|fan4Out_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = fan5Out_Pin|fan6Out_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PA3     ------> TIM5_CH4
    */
    GPIO_InitStruct.Pin = fan7Out_Pin|fan8Out_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC9     ------> TIM8_CH4
    */
    GPIO_InitStruct.Pin = RGB1_Pin|RGB2_Pin|RGB3_Pin|RGB4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA11     ------> TIM1_CH4
    */
    HAL_GPIO_DeInit(GPIOA, fan1In_Pin|fan2In_Pin|Fan1Out_Pin|Fan2Out_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PB3     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOB, fan3Out_Pin|fan4Out_Pin|fan4In_Pin);

    HAL_GPIO_DeInit(fan3In_GPIO_Port, fan3In_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB1     ------> TIM3_CH4
    */
    HAL_GPIO_DeInit(GPIOA, fan5In_Pin|fan6In_Pin);

    HAL_GPIO_DeInit(GPIOB, fan5Out_Pin|fan6Out_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA3     ------> TIM5_CH4
    */
    HAL_GPIO_DeInit(GPIOA, fan7In_Pin|fan8In_Pin|fan7Out_Pin|fan8Out_Pin);
